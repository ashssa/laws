...
tags:
  ...
  # - 設計理念
description:
  本文帶你了解法規系統內意想不到的實用小功能！包含頁面內搜尋、錨點連結、功能清單、目次、深色模式、項加註羅馬數字以及其他相關教學文章。
---
...
![錨點連結功能](./301-p02.png)
*點擊條號前方的井字號「＃」，即可移動至該條文的位置，此時複製連結就會帶有該條條文錨點。*
...
*各法規頁面提供三種功能選單，注意中間「法規沿革」按鈕為內部／外部網址。*
...
![項加註羅馬數字](./301-p08.png)
*參照我國法律實務做法，項加註羅馬數字。並僅於2項以上才開始加註數字。*
