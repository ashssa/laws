...
2. **Custom Parser (`src/utils/lawParser.js`):**
   ...
   - _Do not modify this parser's regex without explicit instruction and rigorous testing, as it supports full-width/half-width numbers, `第X條`, `第X條之Y`, and indented sub-paragraphs._
